...
includes importing the appropriate libraries and connecting to the database from where we will pull the COVID-19 data.  Remember,
if you want to run this code, *you must be connected to the VPN*.  
