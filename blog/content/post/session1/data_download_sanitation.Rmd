...
`recovered`) and plot each to the same axes.  For visual clarity, we choose to
...
ggplot(melted.dt, aes(x=last_update, y=number.reported, color=cases)) +
    ...
    annotation_logticks() +
    ggtitle(paste("Total Cases in", country.switch, "By Type"))
```

***

This plot may seem simple, but beneath it lies a wealth of information.  What
questions do you have after viewing?
