...
To view and download the code and run it yourself, head on over to the [GitHub site](https://github.com/H4estu/COVID19-Data-Exploration/blob/dev/scripts/R/session4/modeling_basics.R)
