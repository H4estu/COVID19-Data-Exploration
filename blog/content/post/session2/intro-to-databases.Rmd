...
by moving the csv data that we dowloaded from the [JHU CSSE database](https://github.com/CSSEGISandData/COVID-19) to a local PostgresSQL instance on 
his machine and demoing some simple commands.  The main  updates to the code in the 
session were:
