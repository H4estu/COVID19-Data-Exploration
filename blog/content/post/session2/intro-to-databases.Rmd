...
# us_data_cropped.dt <- us_data.dt[which(us_data.dt$longitude > -125.77148 & 
#                                        us_data.dt$longitude < -64.59961 &
#                                        us_data.dt$latitude > 23.24135 &
#                                        us_data.dt$latitude < 48.86471),]
# 
# us_data_cropped.dt$fips%>% unique
plot(us_data.sf['confirmed'], extent=bound)
# ggplot() + geom_polygon(data=us_data.dt, aes(x=longitude, y=latitude))
```
